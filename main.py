...
if do_segment == 'True':
    ...
    Youtube_music_path_m4a = os.path.join(
        Youtube_music_path, 'youtube_music' + '.m4a')
    print(Youtube_music_path_m4a)
    Youtube_music_path_wav = Youtube_music_path + "/" + 'youtube_music' + '.wav'
    ...
    json_file = moises_isolate_voice('voice_isolated_moises', url, KEY_ORCHES)
    # print(json_file)
    ...
    file = os.path.join(isolated_voice_path, 'voice_isolated_moises' + '.wav')
    file2 = os.path.join(isolated_background_path,
                         'isolated_moises' + '_background' + '.wav')
    ...
    # Make voice segments
    audio_path = os.path.join(isolated_voice_path, 'voice_isolated_moises' + '.wav')
...
if do_concatenate == 'True':
    ...
    full_audio = concatenate_segments(
        concatene_list, concatenate_segments_path, SAMPLING_RATE, 'concatenated')

    # mixer voice and background

    new_voice_path = os.path.join(
        concatenate_segments_path, 'concatenated' + 'full_audio' + '.wav')
    ...
    file = os.path.join(new_speaker_path, 'new_speaker' + '.wav')
